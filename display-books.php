                            ...
                            <tbody style="color:darkgreen; font-weight: bold;">
                             <?php
                                ...
                                while ($row = mysqli_fetch_array($res)) {
                                    ...
                                    echo "</td>";
                                    echo "<td>";
                                    ?><a href="bookup.php?book_id=<?php echo $row["book_id"]; ?>"><button class="edit-button">
                                    ...
                                    echo "</td>";
                                    echo "<td>";
                                    ?><a href="delete-book.php?book_id=<?php echo $row["book_id"]; ?>" onclick="return checkdelete ()"><button class="buttons">
                                    <svg
